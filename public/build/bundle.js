...
var app = (function () {
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$4, 59, 4, 1244);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$4, 52, 2, 986);
    			attr_dev(h2, "class", "svelte-1td7xux");
    			add_location(h2, file$4, 53, 2, 1005);
    			attr_dev(li, "class", "svelte-1td7xux");
    			add_location(li, file$4, 51, 0, 979);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    // (57:4) <Button on:click={addToCart}>
    function create_default_slot$1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(57:4) <Button on:click={addToCart}>",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$2, 51, 4, 805);
    			attr_dev(h2, "class", "svelte-9ht2za");
    			add_location(h2, file$2, 52, 4, 826);
    			attr_dev(p, "class", "svelte-9ht2za");
    			add_location(p, file$2, 53, 4, 847);
    			add_location(div0, file$2, 50, 2, 795);
    			add_location(div1, file$2, 55, 2, 879);
    			attr_dev(div2, "class", "product svelte-9ht2za");
    			add_location(div2, file$2, 49, 0, 771);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
