...
var app = (function () {
    ...
    /* src\UI\Button.svelte generated by Svelte v3.47.0 */
    ...
    /* src\Cart\CartItem.svelte generated by Svelte v3.47.0 */
    const file$4 = "src\\Cart\\CartItem.svelte";

    // (53:2) <Button mode="outline" on:click={displayDescription}>
    function create_default_slot_1(ctx) {
    	let t_value = (/*showDescription*/ ctx[3]
    	? 'Hide Description'
    	: 'Show Description') + "";
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*showDescription*/ 8 && t_value !== (t_value = (/*showDescription*/ ctx[3]
    			? 'Hide Description'
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(53:2) <Button mode=\\\"outline\\\" on:click={displayDescription}>",
    		ctx
    	});
    ...
    // (56:2) <Button on:click={removeFromCart}>
    function create_default_slot$2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(56:2) <Button on:click={removeFromCart}>",
    		ctx
    	});
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$4, 57, 4, 1163);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(57:2) {#if showDescription}",
    		ctx
    	});
    ...
    function create_fragment$4(ctx) {
    	...
    	let if_block = /*showDescription*/ ctx[3] && create_if_block$1(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$4, 50, 2, 905);
    			attr_dev(h2, "class", "svelte-1td7xux");
    			add_location(h2, file$4, 51, 2, 924);
    			attr_dev(li, "class", "svelte-1td7xux");
    			add_location(li, file$4, 49, 0, 898);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*$$scope, showDescription*/ 136) {
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	function displayDescription() {
    		$$invalidate(3, showDescription = !showDescription);

    		const unsubscribe = products.subscribe(prods => {
    			$$invalidate(2, description = prods.find(prod => prod.id === id).description); //this way you just get the one you need
    		});
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('showDescription' in $$props) $$invalidate(3, showDescription = $$props.showDescription);
    	};
    ...
    /* src\Cart\Cart.svelte generated by Svelte v3.47.0 */
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$3, 49, 6, 837);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, p, anchor);
    		},
    ...
    // (47:4) {#each $cartItems as item (item.id)}
    function create_each_block$1(key_1, ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(47:4) {#each $cartItems as item (item.id)}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$3, 44, 2, 687);
    			attr_dev(ul, "class", "svelte-1c2znv1");
    			add_location(ul, file$3, 45, 2, 703);
    			attr_dev(section, "class", "svelte-1c2znv1");
    			add_location(section, file$3, 43, 0, 675);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== '$$' && key !== 'slot') console_1.warn(`<Cart> was created with unknown prop '${key}'`);
    	});
    ...
    /* src\Products\Product.svelte generated by Svelte v3.47.0 */
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$2, 49, 4, 756);
    			attr_dev(h2, "class", "svelte-9ht2za");
    			add_location(h2, file$2, 50, 4, 777);
    			attr_dev(p, "class", "svelte-9ht2za");
    			add_location(p, file$2, 51, 4, 798);
    			add_location(div0, file$2, 48, 2, 746);
    			add_location(div1, file$2, 53, 2, 830);
    			attr_dev(div2, "class", "product svelte-9ht2za");
    			add_location(div2, file$2, 47, 0, 722);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src\Products\Products.svelte generated by Svelte v3.47.0 */
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 29, 2, 508);
    			attr_dev(section, "class", "svelte-o8blwk");
    			add_location(section, file$1, 28, 0, 496);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    // (11:0) <Button on:click={() => showCart = !showCart}>
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(11:0) <Button on:click={() => showCart = !showCart}>",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	let if_block = /*showCart*/ ctx[0] && create_if_block(ctx);
